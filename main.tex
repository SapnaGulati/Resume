...
\datecolor{July,2019-Now} \runsubsection{Android Social Media App}
\descript{Social Media App}
\noindent
\hspace{5em}%
\begin{minipage}{0.85\textwidth\vspace{2pt}}
...
\noindent\rule{12.5cm}{0.4pt}
\datecolor{July,2019} \runsubsection{Java Developer, Solitaire Infosys, Mohali.}
